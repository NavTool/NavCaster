...
void ClientDataController::loadData(const QString UID)
{
    // //创建一个线程执行数据读取操作
    ...
    //         MonitorCore::getInstance()->forEachClient(
    //             [this](const std::string &key, const std::shared_ptr<client_info> &st)
    //             {
    //                 auto info = st->info();
