...
Item {
    ...
    Component.onCompleted: {
        ...
        //创建刷新数据操作
        CasterMonitor.refreshAllPullState()
        refreshDataOpUid = CasterMonitor.refreshAllPullRecord()
    ...
    SplitView {
        ...
        Frame {
            ...
            Component.onCompleted: {
                ...
                var item= CasterMonitor.generatePullRecordTemp()
            ...
            RowLayout{
                ...
                Button{
                    ...
                    onClicked: {
                        ...
                        root.addTaskOpUid= CasterMonitor.addPullRecord(item.uid, item)
                        ...
                        footer:DialogButtonBox {
                            Button {
                                ...
                                onClicked: {
                                    ...
                                    root.delTaskOpUid= CasterMonitor.delPullRecord(rowModel.uid)
