...
Item {
    ...
    property int   expanderHeight:40
    property alias headerItem: loader_header.item
    property alias leadingItem: loader_leading.item
    property alias trailingItem: loader_trailing.item
    property alias contentItem: loader_content.item
    property string title
    property alias button: layout_control
    id:control
