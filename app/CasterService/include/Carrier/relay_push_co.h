/*
    relay_push_co.h — 协程版本的 relay 推送 Carrier（混合设计）
...
class relay_push_co : public carrier_coroutine
{
public:
    relay_push_co(ConnectInfo info) : carrier_coroutine(info)
    {
        __class__ = "relay_push_co";
    }

    ~relay_push_co() = default;
