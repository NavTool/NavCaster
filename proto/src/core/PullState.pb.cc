...
const ::uint32_t
    TableStruct_core_2fPullState_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        PROTOBUF_FIELD_OFFSET(::caster::core::PullState, _impl_.err_msg_),
...
const char descriptor_table_protodef_core_2fPullState_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\024core/PullState.proto\022\013caster.core\032\014Com"
...
static const ::_pbi::DescriptorTable* PROTOBUF_NONNULL const
    descriptor_table_core_2fPullState_2eproto_deps[1] = {
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_core_2fPullState_2eproto = {
    ...
    descriptor_table_core_2fPullState_2eproto_deps,
    1,
    1,
    schemas,
...
PullState::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastUS1,
     {50, 2, 0,
      PROTOBUF_FIELD_OFFSET(PullState, _impl_.err_msg_)}},
    // string node_uid = 7;
    {::_pbi::TcParser::FastUS1,
     {58, 3, 0,
    ...
    // .caster.RelayState state = 4;
    {PROTOBUF_FIELD_OFFSET(PullState, _impl_.state_), _Internal::kHasBitsOffset + 6, 0, (0 | ::_fl::kFcOptional | ::_fl::kOpenEnum)},
    // string connect_key = 5;
    ...
    // string err_msg = 6;
    {PROTOBUF_FIELD_OFFSET(PullState, _impl_.err_msg_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // string node_uid = 7;
    {PROTOBUF_FIELD_OFFSET(PullState, _impl_.node_uid_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
    "\25\3\0\0\0\13\7\10"
...
::uint8_t* PROTOBUF_NONNULL PullState::_InternalSerialize(
  ...
  if (CheckHasBit(cached_has_bits, 0x00000004U)) {
    if (!this_._internal_err_msg().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "caster.core.PullState.err_msg");
