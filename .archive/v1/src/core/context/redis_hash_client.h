...
public:
    ...
    virtual std::string type(const char *key) { return "none"; }
    virtual long long hlen(const char *key) { return 0; }
    virtual long long llen(const char *key) { return 0; }
    virtual long long memory_usage(const char *key) { return 0; }
