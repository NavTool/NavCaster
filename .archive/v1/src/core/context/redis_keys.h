...
inline constexpr const char *RUNTIME_REJECTION_PREFIX = "RUNTIME:REJECTION:";
...
inline constexpr const char *OPS_ALERT_EVENT_PREFIX = "OPS:ALERT:EVENT:";
...
std::string runtime_rejection(const std::string &period);
...
std::string operations_alert_event(const std::string &period);
