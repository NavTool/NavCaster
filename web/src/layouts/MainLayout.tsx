...
const adminMenuItems = [
  {
    ...
    children: [
      ...
      { key: '/admin/runtime-rejections', icon: <StopOutlined />, label: '接入拒绝' },
      ...
      { key: '/admin/data-push-jobs', icon: <SwapOutlined />, label: '推送任务' },
      { key: '/admin/data-push-usage', icon: <SwapOutlined />, label: '推送用量' },
