    ...
    <HashRouter>
      <Routes>
        ...
        >
          ...
          <Route path="runtime-rejections" element={<OperationsDashboard scope="admin" view="runtime-rejections" />} />
          <Route path="subscription-plans" element={<OperationsDashboard scope="admin" view="subscription-plans" />} />
