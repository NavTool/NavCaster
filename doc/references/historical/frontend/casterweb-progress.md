...
3. **依赖安装**: 历史路径为 `app/CasterWeb`；当前前端位于 `web`，依赖安装以 `current/web-console.md` 为准。
4. **开发启动**: `npm run dev`
...
8. **当前入口**: 新对话中应先阅读 `doc/README.md`，本文档只用于追溯早期迁移历史。
